...
function computeRemainder(n1, n2) {if(n2 == 0) {return Infinity} return n1%n2}
/*-----------------------------------------------------------------
Challenge: 06-range
...
function reverseUpcaseString(string) {return string.toUpperCase().split("").reverse().join("")
}
/*-----------------------------------------------------------------
