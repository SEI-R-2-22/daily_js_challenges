...
function addOne(num) {
  return num + 1
  // return (num++) --> can also work, the parenthesis make this work.
}
/*-----------------------------------------------------------------
...
function removeEnds(string) {
  ...
  let result = ''
  for (let i = 1; 1 < string.length - 1; i++) {
...
function fromPairs(arr) {
  let object = {}
  arr.forEach(function (keyvalueArr) {
    object[keyvalueArr[0]] = keyvalueArr[1]
  })
  return object
}
/*-----------------------------------------------------------------
